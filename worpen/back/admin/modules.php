...
# Count Results
$select_db_count = $connect->prepare("SELECT COUNT(*) FROM worpen_module WHERE name LIKE :search OR date_create LIKE :search OR url LIKE :search");
...
# Search the Database
$select_db = $connect->prepare("SELECT * FROM worpen_module WHERE name LIKE :search OR date_create LIKE :search OR url LIKE :search ORDER BY id LIMIT {$number_result_page}, {$results_for_page}");
